...
// Middleware to initalize session for routes under "/customer" path
...
app.use("/customer/auth/*", function auth(req,res,next){
 ...
 try }
        //Verify the token 
    const verified = jwt.verify(token, "fingerprint_customer"); // Replace "your_secret_key" with your actual secret key
